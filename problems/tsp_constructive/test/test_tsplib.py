...
names = ["ts225", "rat99", "bier127", "lin318", "eil51", "d493", "kroB100", "kroC100", "ch130", "pr299", "kroA150", "pr264", "pr226"]
...
def select_next_node_v2(current_node: int, destination_node: int, unvisited_nodes: set,
    ...
    for node in unvisited_nodes:
        ...
        unvisited_distances = np.append(unvisited_distances,
        ...
        next_unvisited_distances = np.append(next_unvisited_distances.flatten(),
                                             [distance_matrix[unvisited_node_list][:, current_node],
                                              distance_matrix[unvisited_node_list][:, destination_node]])
        ...
        next_scores = c1 * distance_matrix[current_node][
            unvisited_node_list] - c2 * next_average_distance_to_unvisited + c3 * next_std_dev_distance_to_unvisited - c4 * \
        ...
        score = c1 * distance_matrix[current_node][
            node] - c2 * average_distance_to_unvisited + c3 * std_dev_distance_to_unvisited - c4 * \
